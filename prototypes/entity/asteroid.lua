...
local asteroids_data =
{
  ...
  {
    order = "t",
    mass = {shared_mass[1], shared_mass[2], shared_mass[3], shared_mass[4], shared_mass[5]},
    max_health = {shared_health[1], shared_health[2], shared_health[3], shared_health[4], shared_health[5]},
    ...
    shading_data =
    {
      ...
      sss_amount = 0.15,
      lights = {
        { color = {0.1,1,0.1}, direction = {0.75,0.22,-1} },
        { color = {0.2,5,2}, direction = {0.5, 0, 0.95} },
      },
      ambient_light = {0.0, 0.5, 0.0},
    }
  },
}
...
local function asteroid_variation(asteroid_type, suffix, scale, size)
  return
  {
    color_texture =
    {
      filename = "__tiberium-asteroids__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
    ...
    normal_map =
    {
      filename = "__tiberium-asteroids__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-normal-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    },
    ...
    roughness_map =
    {
      filename = "__tiberium-asteroids__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-roughness-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    }
...
for asteroid_size, asteroid_size_name in pairs(asteroid_sizes) do
  for asteroid_type, asteroid_data in pairs(asteroids_data) do
    ...
    local variations ={}
    if (asteroid_type == "tiberium") then
      if (asteroid_size_name == "chunk") then
    ...
    {
      {
        ...
        icon = "__tiberium-asteroids__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
